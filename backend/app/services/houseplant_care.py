...
_LIGHT_PATTERNS: list[tuple[str, re.Pattern]] = [
    ...
    # «Ближе к свету» и «нуждается в свете» — так пишет Сааков, и без этих слов
    # у фикуса, одного из самых частых снимков, свет оставался неразобранным.
    ("bright", re.compile(r"ярко освещ|хорошо освещ|светл\w+ место|самое светлое|"
                          ...
                          r"хорошем освещении|осветлённ|осветленн|в светлых|"
                          r"ближе к свету|нужда\w+ в свете|требу\w+ свет|"
                          r"много свет", re.I)),
