...
_PART_CANON = {
    ...
    # fungal parts (mushroom guides) — collapse plural/case to a canonical head
    # so шляпка/ножка/мякоть/гименофор/плодовое тело are recognised, not "unknown".
    "шляпка": "шляпка", "шляпки": "шляпка", "ножка": "ножка", "ножки": "ножка",
    "мякоть": "мякоть", "гименофор": "гименофор",
    "плодовое тело": "плодовое тело", "плодовые тела": "плодовое тело",
}
